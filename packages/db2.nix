  ...
  pkgs.stdenv.mkDerivation {
    ...
    installPhase =
      ...
      then ''
        ...
        tar --extract \
          --gunzip \
          --file ./drivers/macos/v${args.version}/ibm_data_server_driver_for_odbc_cli.tar.gz \
          --directory ./drivers
      ...
      ''
        ...
        tar --extract \
          --gunzip \
          --file ./drivers/linux/v${args.version}/ibm_data_server_driver_for_odbc_cli.tar.gz \
          --directory ./drivers
        cp -r ./drivers/clidriver/adm $out
        cp -r ./drivers/clidriver/bin $out
        cp -r ./drivers/clidriver/cfg $out
